...
public class BaseActionsUI {
    ...
    public static final String RADIO_BUTTON_BY_LABEL_NAME="xpath=//label[string()='%s']/input";
    public static final String CHECKBOX_BY_LABEL_NAME="xpath=//label[string()='%s']/input";
}
