...
public class EmployeeListPageUI {
    ...
    public static final String EDIT_ICON_BY_EMPLOYEEID="xpath=//div[text()='%s']/parent::div/following-sibling::div/div[@class='oxd-table-cell-actions']//i[contains(@class,'bi-pencil-fill')]";
}
