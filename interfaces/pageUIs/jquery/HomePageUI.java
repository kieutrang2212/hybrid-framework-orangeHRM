...
public class HomePageUI {
    ...
    public static final String PAGE_LINK_ACTIVE_BY_NUMBER="xpath=//a[contains(@class,'active') and text()='%s']";
    ...
    public static final String ROW_ACTION_BY_COUNTRY="xpath=//td[@data-key='country' and text()='%s']/preceding-sibling::td[@class='qgrd-actions']/button[contains(@class,'%s')]";
    ...
    public static final String DYNAMIC_TEXTBOX_BY_COLUMN_NAME_AND_ROW_INDEX="xpath=//tr[%s]/td[%s]/input";
    public static final String DYNAMIC_DROPDOWN_BY_COLUMN_NAME_AND_ROW_INDEX="xpath=//tr[%s]/td[%s]//select";
    public static final String DYNAMIC_CHECKBOX_BY_COLUMN_NAME_AND_ROW_INDEX="xpath=//tr[%s]/td[%s]//input";
